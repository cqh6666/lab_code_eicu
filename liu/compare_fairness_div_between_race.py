...
for threshold_id in threshold_used:
    ...
    for fairness_measure in ['TPR','FPR','odds','PPV']:
        ...
        white_vs_black.to_csv('/home/liukang/Doc/fairness_analysis/subgroup_top20_white_div_black_fairness_{}.csv'.format(measure_select))
        white_vs_non_white.to_csv('/home/liukang/Doc/fairness_analysis/subgroup_top20_white_div_non_white_fairness_{}.csv'.format(measure_select))
...
AKI_white_vs_black.to_csv('/home/liukang/Doc/fairness_analysis/subgroup_top20_white_div_black_fairness_AKI_num.csv')
AKI_white_vs_non_white.to_csv('/home/liukang/Doc/fairness_analysis/subgroup_top20_white_div_non_white_fairness_AKI_num.csv')
...
nonAKI_white_vs_black.to_csv('/home/liukang/Doc/fairness_analysis/subgroup_top20_white_div_black_fairness_nonAKI_num.csv')
nonAKI_white_vs_non_white.to_csv('/home/liukang/Doc/fairness_analysis/subgroup_top20_white_div_non_white_fairness_nonAKI_num.csv')
