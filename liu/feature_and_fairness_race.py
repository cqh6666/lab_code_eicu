...
global_coef_record = pd.DataFrame(columns=feature_name)
for data_num in range(1,5):
    ...
    global_coef_record.loc[data_num,:] = global_final_weight
...
global_final_weight_avg = np.array(global_coef_record.mean())
global_score_record = test_total * global_final_weight_avg
...
view_result_record.to_csv('/home/liukang/Doc/fairness_analysis/{}_aurcc_AKIscore_change_feature_2.csv'.format(fairness_target))