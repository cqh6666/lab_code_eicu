...
do
  ...
  do
      nohup python S05_pca_similar_LR.py ${hos_id} 0 ${comp} > log/S05_LR_${hos_id}_tra0_${curStamp}.log 2>&1 &
      echo "submit ["${hos_id} tra0"] success!"
      nohup python S05_pca_similar_LR.py ${hos_id} 1 ${comp} > log/S05_LR_${hos_id}_tra1_${curStamp}.log 2>&1 &
