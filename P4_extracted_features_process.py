...
eg:
python P4_extracted_features_process.py KUMC AKI_1_2_3 2 0
"""
...
if __name__ == "__main__":
    ...
    # load data
    data_path = f'{parent_path}/result/{site_name}/data/{task_name}/{pre_day}/no_rolling'
    # save path
    save_path = f'{parent_path}/result/{site_name}/feature'
    # Feature name file path
    feature_name_path = f'{parent_path}/result/{site_name}/feature/feature_name.csv'
    ...
    feature_missing_info.to_csv(save_path + "/" + task_name + "_" + pre_day + '_features_missing.csv', index=False)
    ...
    final_features.to_csv(save_path + "/" + task_name + "_" + pre_day + FS + '_features.csv', index=False)
    print(save_path)
